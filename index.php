...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body class="container-fluid center">
    ...
    <div class="">
    <div align="center">
      <img class="img-responsive" width="10%" src="img/lc.png" alt=""></div>
   <form class="form-signin" id="form_ingreso" name="form_ingreso" method="POST" action="<?php echo $loginFormAction; ?>">
     ...
     <!-- FOOTER COPYRIGHT START -->
            <p> <a href="https://landercorp.com.mx">landercorp.mx</a> Es una empresa de desarrollo de software y sistemas web.</p>
